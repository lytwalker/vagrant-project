...
if (! (empty ( $_GET ))) {
	...
	if ($id > 0) {
		$res = $dbUtils->InsertUpdateQuery ( "Update base_stations set `Name` = '$name', `Latitude` =  '$latitude', 
		...
		$res = $dbUtils->InsertUpdateQuery ( "INSERT INTO base_stations (`Name`, `Latitude`, `Longitude`, `Tilt`, `Range`, `IsInFibroniksArea`, `Decomissioned`, `Notes`, `Type`)
				VALUES ('$name', '$latitude', '$longitude', $tilt, $range, $isInFibroniksArea, $decomissioned, '$notes', '$type')" );
	}
			...
			<div class="x_content">
				...
				<form method="post" action="edit.php" class="form-horizontal form-label-left">
						...
						<div class="btn_row col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
							<a href="/cms/wimax/" class="btn btn-secondary"><i class="fa fa-arrow-circle-left"></i> Back</a> 
